              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                {[
                  ...
                  <div key={field.name}>
                    <label
                      htmlFor={field.name}
                      className="block text-xs font-heading font-medium tracking-widest uppercase text-muted-foreground mb-2"
                    >
                      {field.label}
                    </label>
                    <input
                      ...
                      type={field.type}
                      required
                      className="w-full bg-transparent border-b border-border px-0 py-3 text-foreground placeholder:text-muted-foreground/40 focus:border-secondary focus:outline-none transition-colors duration-300 text-sm"
                ...
                <button
                  type="submit"
                  className="w-full md:w-auto inline-flex items-center justify-center gap-3 px-8 py-4 bg-secondary text-secondary-foreground font-heading font-semibold text-sm tracking-widest uppercase transition-all duration-300 hover:brightness-110 hover:shadow-lg hover:shadow-secondary/20"
                >
